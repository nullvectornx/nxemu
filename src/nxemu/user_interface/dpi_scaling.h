...
inline void ScaleWindowSizeForDpi(void * parentWindow, int & width, int & height)
{
#ifdef _WIN32
    ...
    static PFN_GetDpiForSystem pGetDpiForSystem = reinterpret_cast<PFN_GetDpiForSystem>(
    ...
    RECT workArea{};
    HMONITOR monitor = parent != nullptr
